<div class="modal fade" id="bkaddModal" tabindex="-1" role="dialog" aria-labelledby="ModalCenter" aria-hidden="true">
            ...
            <form id="add_dog_form" method="post" class="form-horizontal" action="{{$action}}" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-12">
                            <input required type="radio" name="sex" value="1">公 &nbsp
                            <input required type="radio" name="sex" value="0">母
                        </div>
                    </div>
                    <div class="form-group">
